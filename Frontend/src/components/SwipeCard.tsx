...
//   const rotateY = useTransform(y, [-300, 300], [-15, 15]);
...
//       <motion.div 
//         className="absolute inset-0 bg-red-500 rounded-2xl flex items-center justify-center z-10"
...
//       <motion.div 
//         className="absolute inset-0 bg-gray-500 rounded-2xl flex items-center justify-center z-10"
